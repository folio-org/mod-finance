...
public class FundService {
      ...
      .exceptionally(t -> {
        if (t instanceof HttpException) {
          ...
          if (httpException.getCode() == NOT_FOUND) {
            Error error = new Error().withCode(FUND_NOT_FOUND_ERROR.getCode())
  ...
  public CompletableFuture<FundsCollection> getFundsWithAcqUnitsRestriction(String query, int offset, int limit,
    ...
    return acqUnitsService.buildAcqUnitsCqlClause(requestContext)
      ...
      .thenCompose(
          effectiveQuery -> fundStorageRestClient.get(effectiveQuery, offset, limit, requestContext, FundsCollection.class));
  }

  public CompletableFuture<FundsCollection> getFundsWithoutAcqUnitsRestriction(String query, int offset, int limit,
      RequestContext requestContext) {
