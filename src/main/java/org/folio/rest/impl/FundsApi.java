...
public class FundsApi extends BaseApi implements FinanceFunds, FinanceFundTypes{
  ...
  @Validate
  @Override
  public void getFinanceFundsExpenseClassesById(String id, String status, Map<String, String> okapiHeaders
          , Handler<AsyncResult<Response>> handler, Context ctx) {
  ...
  @Validate
  @Override
  public void getFinanceFundsBudgetById(String id, String status,
