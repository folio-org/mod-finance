...
class EncumbrancesTest extends ApiTestBase {
  ...
  void testPostAwaitingPayment() throws IOException {
    ...
    DepricatedAwaitingPayment awaitingPayment = new JsonObject(getMockData("mockdata/awaiting_payment/awaiting_payment_1.json")).mapTo(DepricatedAwaitingPayment.class);
