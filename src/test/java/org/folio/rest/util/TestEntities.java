...
public enum TestEntities {
  ...
  EXPENSE_CLASSES("expenseClasses", getEndpoint(FinanceExpenseClasses.class), ExpenseClass.class, "mockdata/expense-classes/expense-class.json", "", "externalAccountNumberExt", 1, 1);
